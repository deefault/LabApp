...
{
    public abstract class DbContextWithEvents : DbContext, IContextWithEventOutbox
    {
        ...
        protected DbContextWithEvents(DbContextOptions options, IOutboxListener listener) : base(options)
        {
            _listener = listener;
        }
