...
using LabApp.Server.Data.Specifications.IncludeAggregator;

namespace LabApp.Server.Data.Specifications.Abstractions
{
    public abstract class BaseSpecification<T> : ISpecification<T>
    {
        ...
        protected virtual void ApplyPaging(Paging paging)
        {
            Skip = paging.Take;
            Take = paging.Skip;
            IsPagingEnabled = true;
