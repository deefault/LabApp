...
export class UserService {
     ...
     */
    public check(observe?: 'body', reportProgress?: boolean): Observable<any>;
    public check(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public check(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public check(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('get',`${this.basePath}/api/User/Check`,
            {
    ...
    public signOut(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/api/User/SignOut`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public uploadMainPhoto(file?: Blob, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/api/User/UploadProfilePhoto`,
            {
